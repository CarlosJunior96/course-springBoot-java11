...
/** CLASSE DE CONFIGURAÇÃO - ESPECÍFICA PARA O PERFIL
 * DE TESTE DO PROJETO
 * PROFILE INDICA QUE SÓ VAI RODAR A CONFIG QUANDO ESTIVER
 * NO PERFIL DE TESTE
 * **/
...
public class TestConfig implements CommandLineRunner {
    ...
    /** ASSOCIANDO UMA INSTANCIA DO UserRepository
     * ao meu TestConfig
     * **/
    @Autowired
    ...
    public void run(String... args) throws Exception {
        User u1 = new User(null, "Carlos Jr", "maria@gmail.com", "988888888", "123456");
        User u2 = new User(null, "Cordeiro da Silva", "alex@gmail.com", "977777777", "123456");
        ...
        /** QUANDO FAÇO O ASSOCIAMENTO DO PEDIDO E PAGAMENTO O JPA É RESPONSAVEL DE SALVAR O PAGAMENTO **/
        o1.setPayment(pay1);
